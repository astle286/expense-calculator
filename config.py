...
https://www.youtube.com/@astle4387

From now on, every time you change models, run:

powershell
alembic revision --autogenerate -m "Describe change"
alembic upgrade head

TransactionsView will be cool, but already we have TaxCollection page that act as collecting tax and showing previously collected tax aswell for each family, what do you suggest?
